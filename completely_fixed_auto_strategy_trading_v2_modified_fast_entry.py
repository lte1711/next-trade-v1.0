...
class CompletelyFixedAutoStrategyFuturesTrading:
    ...
    def get_ma_trade_decision(self, strategy, market_regime):
        ...
        fast_long_ready = (
            ...
            bullish_cross_ready and
            volume_ready and
            (bullish_breakout_context or bullish_pullback_ready) and
        ...
        fast_short_ready = (
            ...
            bearish_cross_ready and
            volume_ready and
            (bearish_breakout_context or bearish_pullback_ready) and
        ...
        try:
            ...
            return self.submit_order(
                ...
                metadata={
                    ...
                    "entry_mode": best_candidate["market_regime"].get("entry_mode"),
                },
            )
    ...
    def manage_open_positions(self):
        ...
        try:
            ...
            for symbol, position in list(active_positions.items()):
                ...
                if hold_ready and self.manage_profit_targets(symbol, position):
                    continue
                if not hold_ready:
                    continue
