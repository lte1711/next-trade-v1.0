...
class PartialTakeProfitManager:
    ...
    def check_partial_take_profit(self, symbol, position, entry_price, 
        ...
        try:
            ...
            partial_tp1_pct = risk_config.get('partial_tp1_pct', 0.008)  # 0.8%
            partial_tp2_pct = risk_config.get('partial_tp2_pct', 0.015)  # 1.5%
            fast_tp1_pct = risk_config.get('fast_tp1_pct', 0.005)       # 0.5%
            fast_tp2_pct = risk_config.get('fast_tp2_pct', 0.012)       # 1.2%
            fast_tp1_close_ratio = risk_config.get('fast_tp1_close_ratio', 0.50)
