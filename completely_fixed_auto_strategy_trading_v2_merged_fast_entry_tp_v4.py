...
class CompletelyFixedAutoStrategyFuturesTrading:
    ...
    def execute_strategy_trade(self, strategy_name):
        ...
        try:
            ...
            quantity = self.calculate_position_size(strategy_name, best_candidate["symbol"], selected_entry_mode)
            if quantity <= 0:
            ...
            return self.submit_order(
                ...
                metadata={
                    ...
                    "position_size_multiplier_applied": self.fast_entry_size_multiplier if selected_entry_mode in {"FAST_LONG", "FAST_SHORT"} else 1.0,
    ...
    def calculate_position_size(self, strategy_name, symbol, entry_mode=None):
        ...
        try:
            ...
            if entry_mode in {"FAST_LONG", "FAST_SHORT"}:
                quantity *= self.fast_entry_size_multiplier
            min_quantities = {
